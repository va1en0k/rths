...
camera = Camera {
  cOrigin = CVec3 13.0 5.0 19.0,
  cHorizontal = CVec3 (-8.987280150604205) 0.0 4.987280150604205,
  cVertical = CVec3 0.4806138049029842 (-6.4604193953014866) 0.4806138049029842, cLowerLeftCorner = CVec3 12.314843072425312 7.802851336421494 9.327562921821107
}
